 ...
 * jQuery for the UI.
 * 
 * Copyright 2012--2013 Rolf Lindén (rolind@utu.fi), all rights
 * reserved. No copying for any purposes allowed without written and
 * signed authorization. This copyright notice must be presented with
 * the source.
 * 
 * @version 1
 * @author Rolf Lindén (rolind@utu.fi)
...
(function ($) {
	...
	{ /** Calculator functionality   **/
		...
		var init = function (place, params){
            ...
            debug('Calculator.init(): Announcing calculator', $this, announced );
	...
	{ /** jQuery Plugin interface    **/
		var methods = {
			...
			'calculate' : function(params) {
				debug($(this), params, false, latexeval($(this), params, false));
			...
			'unittest' : function(params) {
				...
				if (passed == total) {
					...
					debug('Unit test failed, ', passed, ' out of ', total, 'passed (', passed / total * 100,'%)')
					return false;
				}
			},
